...
A2: scratch for V1  --- gap --- scratch for V1  --- gap --- ...
A3: scratch for V2  --- gap --- scratch for V2  --- gap --- ...
A4: scratch for V3  --- gap --- scratch for V3  --- gap --- ...
```
...
angle you are grading while avoiding sparse empty tracks. A1 is the external
`audio.aif` / `audio-edit.wav` master. A2+ contain camera scratch audio from
the angle source clips and are linked to their video items for sync QA.
